...
node {
	...
	stage('check integration')
	{
		...
		try
		{
			sh 'docker service inspect catiny-services_catinyuaadev-elasticsearch'
			sh 'docker service inspect catiny-services_catinyuaadev-mariadb'
			sh 'docker service inspect catiny-services_catinyuaadev-redis'
